    ...
    private void processJSONdata(String JSONdata, Context mContext, boolean isReal) {
        ...
        try {
            ...
            for (int i = 0; i < matches.length(); i++) {
                ...
                League = match_data.getJSONObject(LINKS)
                ...
                if (League.equals(PREMIER_LEGAUE) ||
                    ...
                    match_id = match_data.getJSONObject(LINKS)
                            .getJSONObject(SELF)
                            .
                                    getString("href");
                    ...
                    Home_goals = match_data.getJSONObject(RESULT)
                            .getString(HOME_GOALS);
                    Away_goals = match_data.getJSONObject(RESULT)
